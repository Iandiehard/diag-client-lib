...
TEST_F(DiagReqResFixture, VerifyPostiveRequestResponse) {
  ...
  UdsMessage::ByteVector uds_payload{0x10, 0x01};
  // Create Uds message
  diag::client::uds_message::UdsRequestMessagePtr uds_message{std::make_unique<UdsMessage>(DiagTcpIpAddress, uds_payload)};
