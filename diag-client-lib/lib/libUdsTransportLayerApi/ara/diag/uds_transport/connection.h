...
public:
  // ctor
  Connection(ConnectionId connection_id, const std::shared_ptr<ara::diag::conversion::ConversionHandler> &conversation)
  ...
  virtual ara::diag::uds_transport::UdsTransportProtocolMgr::DisconnectionResult DisconnectFromHost() = 0;
  ...
  virtual ara::diag::uds_transport::UdsTransportProtocolMgr::TransmissionResult Transmit(
      ara::diag::uds_transport::UdsMessageConstPtr message) = 0;
