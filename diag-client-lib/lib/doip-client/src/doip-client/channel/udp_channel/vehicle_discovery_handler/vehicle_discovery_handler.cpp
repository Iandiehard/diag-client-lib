...
VehicleDiscoveryHandler::VehicleDiscoveryHandler(sockets::UdpSocketHandler &udp_socket_handler,
                                                 DoipUdpChannel &)
...
void VehicleDiscoveryHandler::ProcessVehicleAnnouncementResponse(DoipMessage &) const noexcept {
