...
*/
#ifndef DOIP_CLIENT_CHANNEL_UDP_CHANNEL_VEHICLE_DISCOVERY_HANDLER_VEHICLE_DISCOVERY_HANDLER_H_
#define DOIP_CLIENT_CHANNEL_UDP_CHANNEL_VEHICLE_DISCOVERY_HANDLER_VEHICLE_DISCOVERY_HANDLER_H_
...
namespace vehicle_discovery_handler {
...
class VehicleDiscoveryHandler final {
 ...
 public:
   ...
   */
  void ProcessVehicleAnnouncementResponse(DoipMessage &doip_payload) const noexcept;
...
#endif  //DOIP_CLIENT_CHANNEL_UDP_CHANNEL_VEHICLE_DISCOVERY_HANDLER_VEHICLE_DISCOVERY_HANDLER_H_
