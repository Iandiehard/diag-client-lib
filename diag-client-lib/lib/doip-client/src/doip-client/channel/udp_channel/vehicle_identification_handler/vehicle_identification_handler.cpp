...
*/
constexpr std::uint16_t kDoipVehicleIdentificationReq{0x0001};
constexpr std::uint16_t kDoipVehicleIdentificationEIDReq{0x0002};
constexpr std::uint16_t kDoipVehicleIdentificationVINReq{0x0003};

/**
* @brief       Payload length excluding header
*/
constexpr std::uint32_t kDoipVehicleIdentificationReqLen{0u};
constexpr std::uint32_t kDoipVehicleIdentificationEIDReqLen{6u};
constexpr std::uint32_t kDoipVehicleIdentificationVINReqLen{17u};
...
auto GetVehicleIdentificationPayloadType(std::uint8_t preselection_mode) noexcept
  ...
  switch (preselection_mode) {
    case 0U:
      vehicle_identification_type = kDoipVehicleIdentificationReq;
      vehicle_identification_length = kDoipVehicleIdentificationReqLen;
      break;
    case 1U:
      vehicle_identification_type = kDoipVehicleIdentificationVINReq;
      vehicle_identification_length = kDoipVehicleIdentificationVINReqLen;
      break;
    case 2U:
      vehicle_identification_type = kDoipVehicleIdentificationEIDReq;
      vehicle_identification_length = kDoipVehicleIdentificationEIDReqLen;
      break;
    default:
      break;
  }
  ...
  if (handler_impl_->GetStateContext().GetActiveState().GetState() ==
    ...
    if (SendVehicleIdentificationRequest(std::move(vehicle_identification_request)) ==
      ...
      handler_impl_->GetSyncTimer().WaitForTimeout(
          ...
          std::chrono::milliseconds{message::kDoIPCtrl});
...
auto VehicleIdentificationHandler::SendVehicleIdentificationRequest(
  ...
  if (doip_vehicle_payload_type.first != kDoipVehicleIdentificationReq) {
    compose_vehicle_identification_req.insert(
        compose_vehicle_identification_req.begin() + message::kDoipHeaderSize,
