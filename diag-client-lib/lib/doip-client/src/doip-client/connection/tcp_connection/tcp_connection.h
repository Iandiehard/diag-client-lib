...
#ifndef DOIP_CLIENT_CONNECTION_TCP_CONNECTION_TCP_CONNECTION_H_
#define DOIP_CLIENT_CONNECTION_TCP_CONNECTION_TCP_CONNECTION_H_
...
class DoipTcpConnection final : public uds_transport::Connection {
 public:
  ...
  DoipTcpConnection(uds_transport::ConversionHandler const &conversation_handler,
                    std::string_view tcp_ip_address, std::uint16_t port_num) noexcept;
