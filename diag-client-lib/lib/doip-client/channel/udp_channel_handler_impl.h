 ...
 */
#ifndef DIAGNOSTIC_CLIENT_LIB_LIB_DOIP_CLIENT_CHANNEL_UDP_CHANNEL_HANDLER_IMPL_H
#define DIAGNOSTIC_CLIENT_LIB_LIB_DOIP_CLIENT_CHANNEL_UDP_CHANNEL_HANDLER_IMPL_H
//includes
#include <mutex>
...
#endif  //DIAGNOSTIC_CLIENT_LIB_LIB_DOIP_CLIENT_CHANNEL_UDP_CHANNEL_HANDLER_IMPL_H
