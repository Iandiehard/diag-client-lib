...
auto DoipUdpChannelHandler::ProcessDoIPHeader(DoipMessage &doip_rx_message,
...
auto DoipUdpChannelHandler::ProcessDoIPPayloadLength(std::uint32_t payload_len,
...
void DoipUdpChannelHandler::ProcessDoIPPayload(DoipMessage &doip_payload,
                                               DoipMessage::RxSocketType) {
