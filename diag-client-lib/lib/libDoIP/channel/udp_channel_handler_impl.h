...
public:
  ...
  auto SendVehicleIdentificationRequest(uds_transport::UdsMessageConstPtr& message)
...
private:
  ...
  auto HandleVehicleIdentificationRequest(uds_transport::UdsMessageConstPtr& message)
  noexcept -> uds_transport::UdsTransportProtocolMgr::TransmissionResult;
...
public:
  ...
  auto Transmit(ara::diag::uds_transport::UdsMessageConstPtr& message)
    noexcept -> uds_transport::UdsTransportProtocolMgr::TransmissionResult;
