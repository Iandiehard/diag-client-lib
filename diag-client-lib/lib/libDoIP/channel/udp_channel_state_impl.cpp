...
UdpChannelStateImpl::UdpChannelStateImpl()
  ...
  // kVdIdle
  GetVehicleDiscoveryStateContext().AddState(VehicleDiscoveryState::kVdIdle,
  ...
  GetVehicleIdentificationStateContext().AddState(
      VehicleIdentificationState::kViIdle, std::move(std::make_unique<kViIdle>(VehicleIdentificationState::kViIdle)));
  // kViSendVehicleIdentificationReq
  GetVehicleIdentificationStateContext().AddState(VehicleIdentificationState::kViSendVehicleIdentificationReq,
                                                  std::move(std::make_unique<kViSendVehicleIdentificationReq>(
                                                      VehicleIdentificationState::kViSendVehicleIdentificationReq)));
  // kViWaitForVehicleIdentificationRes
  GetVehicleIdentificationStateContext().AddState(VehicleIdentificationState::kViWaitForVehicleIdentificationRes,
...
kVdIdle::kVdIdle(VehicleDiscoveryState state) : State(state) {}
...
kWaitForVehicleAnnouncement::kWaitForVehicleAnnouncement(VehicleDiscoveryState state) : State(state) {}
...
kVdDoIPCtrlTimeout::kVdDoIPCtrlTimeout(VehicleDiscoveryState state) : State(state) {}
...
kViIdle::kViIdle(VehicleIdentificationState state) : State(state) {}
...
kViSendVehicleIdentificationReq::kViSendVehicleIdentificationReq(VehicleIdentificationState state) : State(state) {}
...
kViDoIPCtrlTimeout::kViDoIPCtrlTimeout(VehicleIdentificationState state) : State(state) {}
