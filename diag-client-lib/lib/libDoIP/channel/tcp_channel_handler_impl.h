...
public:
  ...
  TcpChannelHandlerImpl(tcpSocket::TcpSocketHandler &tcp_socket_handler,
                        ...
                        tcpChannel::tcpChannel &channel) : routing_activation_handler_{tcp_socket_handler, channel},
                                                           diagnostic_message_handler_{tcp_socket_handler,
                                                                                       tcp_transport_handler,
                                                                                       channel} {}
  ...
  auto SendRoutingActivationRequest(
    ara::diag::uds_transport::UdsMessageConstPtr &message) noexcept -> uds_transport::UdsTransportProtocolMgr::TransmissionResult;
