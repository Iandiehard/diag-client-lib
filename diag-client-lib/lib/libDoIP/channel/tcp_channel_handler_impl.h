...
public:
  // ctor
  RoutingActivationHandler(tcpSocket::TcpSocketHandler &tcp_socket_handler, tcpChannel::tcpChannel &channel) : tcp_socket_handler_{tcp_socket_handler},
                                                                                                               channel_{channel} {}
  ...
  auto SendRoutingActivationRequest(uds_transport::UdsMessageConstPtr &message) noexcept -> uds_transport::UdsTransportProtocolMgr::TransmissionResult;
...
public:
  ...
  DiagnosticMessageHandler(tcpSocket::TcpSocketHandler &tcp_socket_handler,
                           ...
                           tcpChannel::tcpChannel &channel) : tcp_socket_handler_{tcp_socket_handler},
  ...
  auto SendDiagnosticRequest(uds_transport::UdsMessageConstPtr &message) noexcept -> uds_transport::UdsTransportProtocolMgr::TransmissionResult;
...
public:
  ...
  TcpChannelHandlerImpl(tcpSocket::TcpSocketHandler &tcp_socket_handler,
                        tcpTransport::TcpTransportHandler &tcp_transport_handler,
                        tcpChannel::tcpChannel &channel) : routing_activation_handler_{tcp_socket_handler, channel},
  ...
  auto SendRoutingActivationRequest(ara::diag::uds_transport::UdsMessageConstPtr &message) noexcept -> uds_transport::UdsTransportProtocolMgr::TransmissionResult;
  // Function to send Diagnostic request
  auto SendDiagnosticRequest(uds_transport::UdsMessageConstPtr &message) noexcept -> uds_transport::UdsTransportProtocolMgr::TransmissionResult;
  // process message
